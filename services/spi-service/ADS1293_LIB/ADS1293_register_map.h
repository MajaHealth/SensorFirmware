...
typedef struct CHANNEL_PARAM_DATA
{
    int32_t ADC_max;
    int32_t ODR;
    int32_t band_width;
} CHANNEL_PARAM_DATA_TDS;

inline const uint32_t BASE_FREQ_COUNT=2;
inline const uint32_t R1_VAL_COUNT=2;
inline const uint32_t R2_VAL_COUNT=4;
inline const uint32_t R3_VAL_COUNT=8;
inline constexpr CHANNEL_PARAM_DATA_TDS ch_param_table[BASE_FREQ_COUNT][R1_VAL_COUNT][R2_VAL_COUNT][R3_VAL_COUNT] =
{
    {
        {
            {
